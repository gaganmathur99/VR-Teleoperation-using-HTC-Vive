...
{
    [Serializable]
    public class FrankaMoveitJointsMsg : Message
    {
        public const string k_RosMessageName = "project_msg/FrankaMoveitJoints";
        ...
        public FrankaMoveitJointsMsg(double[] joints, Geometry.PoseMsg pick_pose, Geometry.PoseMsg place_pose)
        {
            this.joints = joints;
        ...
        public static FrankaMoveitJointsMsg Deserialize(MessageDeserializer deserializer) => new FrankaMoveitJointsMsg(deserializer);

        private FrankaMoveitJointsMsg(MessageDeserializer deserializer)
        {
